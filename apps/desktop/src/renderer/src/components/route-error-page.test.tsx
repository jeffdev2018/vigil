...
const translations = {
  history: { go_back: "Go back", go_forward: "Go forward" },
  tab_bar: {
    pin_tab: "Pin tab",
    unpin_tab: "Unpin tab",
    close_tab: "Close tab",
  ...
  route_error: {
    ...
    not_found_body:
      "Nothing in Multica matches this address. If you got here from a link, it probably points at a file on someone else's computer rather than a page.",
    go_to_issues: "Go to issues",
    unexpected_title: "Something went wrong in this tab",
    unexpected_body:
