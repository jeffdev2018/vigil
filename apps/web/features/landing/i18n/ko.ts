      ...
      entries: [
        ...
        },
        {
          ...
          features: [
            ...
            "쓸 수 없는 모델은 미리 표시되어, 실행이 실패한 뒤에 알게 되지 않습니다.",
          ...
          improvements: [
            "실패한 위임 태스크를 복구해도 다른 실행이 느려지지 않습니다.",
            "일본어와 한국어 표현이 제품과 문서에서 일관되게 맞춰졌습니다.",
            "줄여서 표시한 문장에서도 이모지가 깨지지 않습니다.",
          ],
          fixes: [
            "Issue 설명을 수정하면 그대로 저장되고, 근거 없는 충돌 안내가 뜨지 않습니다.",
            "준비 단계에서 실패한 태스크는 그대로 알리고, 모델이나 에이전트 탓으로 돌리지 않습니다.",
            "태스크 로그에 태스크 ID가 전부 표시되어, 동시에 실행 중인 태스크를 구분할 수 있습니다.",
            "뒤이어 실행되는 태스크는 앞선 태스크가 작업 폴더를 놓을 때까지 기다립니다.",
            "같은 세션의 태스크는 같은 브랜치에서 작업을 이어갑니다.",
            "이미 가져온 저장소도 Co-authored-by 설정을 곧바로 따릅니다.",
            "Kimi는 제공자 오류를 그대로 알리고, 답변 없이 성공한 것처럼 보이지 않습니다.",
            "Windows에서도 Pi 세션이 실행됩니다.",
            "Codex 속도를 Standard로 직접 선택할 수 있습니다.",
            "백그라운드 정리는 해당 태스크의 작업 폴더만 삭제합니다.",
            "특수 문자를 정리할 때 저장된 내용이 조용히 사라지지 않습니다.",
            "iOS에서 긴 Markdown 목록을 스크롤해도 화면이 겹치지 않습니다.",
            "태스크 상세의 이미지가 깜빡이지 않고 표시됩니다.",
            "날짜와 금액이 선택한 언어의 형식으로 표시됩니다.",
            "데스크톱 앱의 데몬 조작이 모두 번역되었습니다.",
          ],
        },
        {
          version: "0.4.37",
