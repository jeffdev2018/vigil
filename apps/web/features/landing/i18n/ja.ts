      ...
      entries: [
        ...
        },
        {
          ...
          features: [
            ...
            "コマンドラインでスキルにラベルを付けられ、スキルのページでラベルで絞り込めます。",
            "Oh-My-Pi のエージェントに思考レベルを設定できます。",
            "コマンドラインで投稿済みのコメントを編集でき、他の人の同時の編集を上書きしません。",
            "Issue 一覧を、所属するプロジェクトのステータスで絞り込めます。",
          ...
          fixes: [
            "WeCom で続けて送っても、メッセージが落ちません。",
            "エージェントの WeCom ボットを入れ替えると、前のボットの情報が残りません。",
            "WeCom と DingTalk のグループで引用したメッセージも、依頼と一緒にエージェントへ届きます。",
            "DingTalk の返信は、最初のメッセージからどのエージェントが答えているか分かります。",
            "取り消された連携は、切断済みとして表示されます。",
            "Grok、Pi、Copilot、Codex の実行が、黙って失敗したり返答の一部を落としたりしません。",
            "Cursor のセッションは接続タイムアウトのあとも残り、そのまま続けられます。",
            "古い OpenCode がディスクを埋め尽くすことはありません。",
            "Hermes のタスクが終了処理で止まりません。",
            "デスクトップアプリが自分で入れたコマンドラインツールを見つけ、CodeBuddy の返答も全部表示されます。",
            "Windows の実行が、自分で設定したツールのパスを使います。",
            "プライベートランタイムが、所有者の食い違いで使えなくなりません。",
            "タスクの費用と使用量が漏れずに記録されます。",
            "タスク内のコミットが、そのタスク自身の Git の情報を使います。",
            "再接続したあとも、タスクの最終結果が届きます。",
            "子タスクを取り消したとき、親のステージの進み方が正しくなります。",
            "別の場所で完了した招待が、保留のまま残りません。",
            "メンションの候補が語の途中でも開き、該当なしのときも操作できます。",
            "サイドバーの PR 連携と @all の説明が、誤解を招きません。",
            "Quick Create が入力した内容をそのまま残します。",
          ],
        },
        {
          version: "0.4.44",
          date: "2026-09-15",
          title: "DingTalk の引用返信、Issue ステータス設定の刷新、実行使用量の精度向上、より安全なコメント削除",
          changes: [],
          features: [
            "DingTalk のグループでの返信が、送ったメッセージを引用します。",
            "DingTalk は依頼の実行中にリアクションを付け、終わったらもう一度付けます。",
            "DingTalk のコマンドの受付メッセージに入力した内容が残り、作られた Issue に紐づきます。",
            "設定の Issue ステータスが、未着手・進行中・完了・クローズにまとまります。",
            "組み込みも含めてステータスをドラッグして、ボードや一覧、メニューでの位置を決められます。",
            "カスタムステータスのアイコンの形を選べます。",
            "DeepSeek Harness Desktop を入れておくだけでランタイムとして認識されます。",
            "セルフホストのサーバーが匿名のデプロイ概要を毎日 1 回送ります。DO_NOT_TRACK=1 で止められます。",
          ],
          improvements: [
            "ステータスをアーカイブするとき、まだ使っている Issue の数が分かり、そこへ移動できます。",
            "起動できない DeepSeek Harness ランタイムが、何が足りないかを伝えます。",
            "コマンドラインで、各オートパイロットの直近の実行結果が分かります。",
            "Issue のエージェントの各手順に、そのとき何を扱っていたかが表示されます。",
            "Issue 一覧の更新中はページタイトルで分かり、速い更新ではちらつきません。",
            "エージェントが長い最終コメントを出すときの締めが速くなりました。",
          ],
          fixes: [
            "コメントを削除しても、その下に付いた返信は残ります。",
            "削除された返信は跡を残さず、そこへのリンクは隣のメッセージに着きます。",
            "Issue 一覧のステータス並べ替えが、自分で決めた順に戻りました。",
            "自分のエージェントが作った Issue が待ち状態になると、知らせが届きます。",
            "同じエージェントへの依頼が同時に 2 件来ても、失敗せず 1 つの実行にまとまります。",
            "失敗した委任タスクが、そのまま置かれずに再び引き取られます。",
            "Claude、Codex、CodeBuddy、Qwen などの実行の使用量が過大に出ません。",
            "取り消したタスクは、エージェントの成功率に数えられません。",
            "Codex の実行に、別の会話向けの返信が混ざりません。",
            "Windows で作られたスキルのアーカイブが、そのまま使えるスキルとして取り込まれます。",
            "Hermes が、タスクが実際に動くホームからローカルのスキルを見つけます。",
            "WeCom がファイルの前に空のメッセージを送らず、送れなかったときは知らせます。",
            "Lark の連携 QR コードが 1 時間そのまま使え、最初の確認で切れません。",
            "古いバージョンのデスクトップアプリでも、サーバー更新後もカスタムステータスが残ります。",
            "サイドバーの Discord の案内を閉じたあとも、ヘルプの位置が揃います。",
            "セルフホストの Web イメージに最新の OpenSSL セキュリティ修正が入りました。",
          ],
        },
        {
          version: "0.4.43",
          date: "2026-09-11",
          title: "コメントと説明への注釈、デスクトップの履歴メニュー、Issue ボードの新しい初期表示、パフォーマンス改善",
          changes: [],
          features: [
            "コメントの文字を選んで注釈を付けると、返信に引用として載ります。",
            "Issue の説明の文字を選ぶと、そこから新しいスレッドを始められます。",
            "デスクトップの戻る／進むに最近見たページが並び、そこへ直接移動できます。",
            "新しい Issue の表示は最新の作業に絞られ、保存した並び順もそのまま使われます。",
            "トランスクリプトに、ツール出力が全部残っていないことが表示されます。",
            "実行履歴で、誰がタスクを取り消したかが分かります。",
            "コマンドラインからエージェントの会話スターターを設定・削除できます。",
            "GPT-6 Astra が公開価格つきで選べます。",
            "セルフホストのサーバーを Redis クラスターやマネージドの Serverless で動かせます。",
          ],
          improvements: [
            "Inbox が速く開き、長いコメントがあっても一覧が重くなりません。",
            "タスクの実行中にコメントを書いても、長い記録でも入力が滑らかです。",
            "全体の角丸のスタイルが揃いました。",
            "ウィンドウが狭くても、Inbox で開いた内容が読めます。",
          ],
          fixes: [
            "サーバー側の一瞬の不調で、まだ動いているタスクが終わらされません。",
            "再試行や同じリポジトリの再取得でも、前回の変更がそのまま残ります。",
            "Inbox を開き直したとき、離れている間に届いた通知が漏れません。",
            "Lark の通常グループでの返信が、元のメッセージと質問した人を保ちます。",
            "リーダーが受け取ったあとの Squad メンバーの返信も、きちんと届きます。",
            "以前に作られたオートパイロットのトリガーが、飛ばされずに動きます。",
            "使用量が、トークンの集計が一部だけであることを示します。",
            "Antigravity の実行でも、使用量と費用が記録されます。",
            "ツールの各ステップに、実際にかかった時間が表示されます。",
            "GitHub の PR は、明示された箇所だけで Issue に紐づきます。",
            "Issue のエージェント実行が、実際に起きた時刻の順に並びます。",
            "内容が長いダイアログでも、下のボタンを押せます。",
            "Codex の準備に失敗したときは、そのまま使い回さずに止まります。",
            "実際に変わっていないときは、Issue に更新が出ません。",
            "Web 版に最新のセキュリティ修正を適用しました。",
          ],
        },
        {
          version: "0.4.42",
          date: "2026-09-09",
          title: "コメントスレッド内のエージェント実行、Issue のスレッド アウトライン、より確実なチャネル返信、大きなワークスペースでも安定した検索",
          changes: [],
          features: [
            "エージェントの待ち順、実行状況、手順、ログが、そのコメントスレッドの中に表示されます。",
            "同じスレッドで指示を足すと、いま動いている実行にそのまま加わります。",
            "コメントスレッドごとに別々の待ち順になり、指示が別のスレッドの実行に混ざりません。",
            "右側のアウトラインに、Issue 内のすべてのスレッド、参加者、完了の状況が並びます。",
          ],
          improvements: [
            "大きなワークスペースでも、検索が途中で止まりません。",
            "長いスレッドの題名がアウトラインで 1 行に収まります。",
          ],
          fixes: [
            "Codex の実行を取り消しても、その実行の使用量と費用は残ります。",
            "最初のセッションが失敗したランタイムが、そのまま止まらなくなりました。",
            "Cursor がバックグラウンドで動かすコマンドが待機と誤判定されず、タスク終了時に片付きます。",
            "Telegram の返信が、送信中の仮メッセージと重なって届かなくなりました。",
            "DingTalk で選んだ引用が残り、/new と /clear が入力中の文章を消しません。",
            "Lark の DM に連携カードを送れないとき、グループでその旨をお知らせします。",
            "チャネルから作った Issue のリンクが、そのまま開けます。",
            "あるエージェントのスレッドへの返信はそのエージェントが続け、余分なタスクは残りません。",
            "マウスでログを開いたあとの Esc で、何も残らなくなりました。",
            "クイック作成した Issue に、関係のないアクティビティが出なくなりました。",
            "ツール出力のプレビューで文字が途中で切れなくなりました。",
            "リクエストの上限に達したときはそう表示され、再サインインを促されません。",
            "コマンドラインが、実際に受け取った Issue のページを正しく返します。",
            "Issue の並べ替えで、間違った位置に入らなくなりました。",
            "Inbox にサイドバーの切り替えが 2 つ並ばなくなりました。",
          ],
        },
        {
          version: "0.4.41",
          date: "2026-09-07",
          title: "新しいサイドバー、用途ごとに分けた設定ページ、大きなワークスペースでも速い検索、Autopilot の手動実行",
          changes: [],
          features: [
            "サイドバーが「仕事」と「AI チーム」に分かれ、Analytics と Settings は下に固定されます。",
            "ピン留めは 5 件まで表示され、残りは開いたときだけ並びます。",
            "設定ページが個人・ワークスペース・Issue・接続・デスクトップの用途ごとに分かれました。",
            "連携はすべて 1 ページにまとまり、接続済みかどうかがすぐ分かります。",
            "Issue とチャットの環境設定は、環境設定の中に移りました。",
            "コマンドラインでカスタム プロパティが ID ではなく名前で返ります。",
            "エージェントの 1 回ごとの実行の使用量と費用を、コマンドラインから確認できます。",
            "コマンドラインで必要な Issue の項目だけを受け取れます。",
          ],
          improvements: [
            "エージェント、スキル、ランタイムの詳細ページが、広い画面でもそろって表示されます。",
            "大きなワークスペースでも Issue 検索が速く、複数の語で検索しても止まりません。",
            "Inbox の一覧が既定で狭くなり、開いた内容に使える幅が広がります。",
            "セルフホストのサーバーで、検索が使えるメモリの上限を設定できます。",
          ],
          fixes: [
            "自分で押せる Autopilot の実行を、エージェントが代わりに始められます。",
            "Autopilot の変更は、その裏にいる人の権限で判断されます。",
            "Autopilot の Webhook 認証情報が、リアルタイムの更新に出なくなりました。",
            "作業フォルダーが無くなった Pi のタスクは、新しいセッションで始まります。",
            "チャンネルから始めた新しいチャットの題名が、いま送った指示から付きます。",
            "エージェントをアーカイブするとチャットも終わり、Slack で処理中に見えなくなりました。",
            "見えないランタイムのエージェントでも、メンバーがタスクを作れます。",
            "入れ子のリストでの Tab と Enter が、いる階層だけに効きます。",
            "古い設定で失敗し続ける Codex の会話に、直し方が表示されます。",
          ],
        },
        {
          version: "0.4.40",
          ...
          features: [
            ...
            "接続設定の入れ替えは、独立した明確な操作になりました。",
            "MCP サーバーの保存時に、直す必要のある項目まですぐ案内されます。",
          ],
          improvements: [
            "エージェントの 1 回ごとの処理を、各アプリとドキュメントで「実行」と呼びます。",
            "検索結果が速く返ってきます。",
          ],
          fixes: [
            "手元のアプリとサーバーのバージョンが違っても、タスクはこれまで通り開始できます。",
            "サインインの期限が切れるとログイン画面に戻り、前のアカウントのデータも消えます。",
            "オフラインでもサインアウトされなくなりました。",
            "他の人のランタイムで共有されたエージェントが、オフラインではなく利用可能と表示されます。",
            "以前に使ったリポジトリのチェックアウトが失敗しなくなりました。",
          ],
        },
        {
          version: "0.4.39",
          ...
          features: [
            ...
            "WeCom では、実行の失敗が始めた会話に返ってきます。",
            "デスクトップ版では数字のショートカットでタブを切り替えられます。",
            "コマンドラインから Issue をカスタム プロパティで絞り込み、並べ替えできます。",
            "カスタム プロパティがまだ未設定の Issue も探せます。",
          ],
          improvements: [
            "Issue の割り当ての手順が減り、すぐに開始しない選択もそのまま使えます。",
            "自己ホストのサーバーが、ランタイムの接続を保つためにかける裏側の処理が減りました。",
            "ランタイムを削除するとすぐに反映され、古い接続が残りません。",
          ],
          fixes: [
            "Squad のリーダーへの返信はそのリーダーが続けて担当し、引き継ぎの内容とセッションが失われません。",
            "長い Issue の識別子が、一覧や表でタイトルを隠さなくなりました。",
            "サインイン、エラー、404 のページが、選んだ言語で表示されます。",
            "途中で言語を切り替えても、サインインは最後まで進みます。",
            "Hermes は選んだモデルのプロバイダーを保ち、勝手に戻しません。",
            "OpenClaw の管理下の MCP サーバーが起動し、自分の MCP 設定はそのまま残ります。",
            "スケジュールと Webhook の Autopilot は、トリガーを作った人の権限で動きます。",
            "作成者を確認できない古いトリガーは、そのまま動かずに止まります。",
            "ワークスペースを離れたメンバーも、活動の記録では元の名前で表示されます。",
          ],
        },
        {
          version: "0.4.38",
