...
| Qualité et intégration globales | Partiel vérifié (build + séquentiel) | `pnpm build` 5/5 OK ; typecheck/séquence antérieure ; Playwright smoke **bloqué** (Docker Desktop down / web :13482) — [quality-build-playwright-2026-09-07.md](quality-build-playwright-2026-09-07.md) |
