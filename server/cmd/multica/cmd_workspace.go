...
func init() {
	...
	workspaceCreateCmd.Flags().String("context", "", "Workspace doctrine, revision 1 (see `multica doctrine`). Decodes \\n, \\r, \\t, \\\\; pipe via --context-stdin to preserve literal backslashes")
	...
	workspaceUpdateCmd.Flags().String("context", "", "New workspace doctrine; publishes a doctrine revision (see `multica doctrine`). Decodes \\n, \\r, \\t, \\\\; pipe via --context-stdin to preserve literal backslashes")
