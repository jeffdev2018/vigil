...
SELECT id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, start_date, due_date, memory_rules, memory_revision, memory_reviewed_by, memory_reviewed_at, memory_expires_at, memory_source_review FROM project
