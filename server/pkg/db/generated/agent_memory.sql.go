...
SELECT agent_memory.id, agent_memory.workspace_id, agent_memory.agent_id, agent_memory.content, agent_memory.source, agent_memory.source_task_id, agent_memory.created_at, agent_memory.updated_at, agent_memory.status, agent_memory.revision, agent_memory.reviewed_by, agent_memory.reviewed_at, agent_memory.expires_at, agent_memory.source_review, t.issue_id AS source_issue_id
FROM agent_memory
