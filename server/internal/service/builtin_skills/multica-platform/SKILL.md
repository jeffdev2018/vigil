...
description: "Platform actions beyond the brief: issues, status transitions, work item types, walkthroughs, review flags, critic verdicts, mentions, agents, squads, autopilots, daemons, projects, cycles, epics, runtimes, run previews, skill import, spending, goals, triage, undo, insights, racing, finish-first."
...
| `references/finish-first.md` | Finish-first coordination and Workspine-lite repo plan files (points at `multica-finish-first`) |
