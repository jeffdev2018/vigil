...
func TestTelemetryMigrationsUpAndDown(t *testing.T) {
	...
	up := []string{
		"964_instance_telemetry_state.up.sql",
		"965_instance_telemetry_state_singleton_index.up.sql",
		"966_instance_telemetry_state_primary_key.up.sql",
		"967_agent_task_queue_telemetry_started_index.up.sql",
	}
	for _, name := range up {
	...
	down := []string{
		"967_agent_task_queue_telemetry_started_index.down.sql",
		"966_instance_telemetry_state_primary_key.down.sql",
		"965_instance_telemetry_state_singleton_index.down.sql",
		"964_instance_telemetry_state.down.sql",
	}
