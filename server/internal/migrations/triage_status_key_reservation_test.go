...
func TestTriageStatusKeyReservationIsNotApplied(t *testing.T) {
	...
	for _, file := range []string{
		"960_issue_status_key_not_reserved.up.sql",
		"961_reserve_triage_status_key.up.sql",
		"962_issue_effective_status_triage.up.sql",
		"975_drop_triage_status_key_reservation.up.sql",
	} {
...
func TestDropTriageStatusKeyReservationRepairsAMigratedDatabase(t *testing.T) {
	...
	applyMigrationFile(t, ctx, s.pool, "975_drop_triage_status_key_reservation.up.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "975_drop_triage_status_key_reservation.down.sql")
	if s.reservationExists(t, ctx) {
