...
func TestIssueTriageStateMigration(t *testing.T) {
	...
	applyMigrationFile(t, ctx, s.pool, "968_issue_triage_state.up.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "974_issue_triage_state_validate.up.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "974_issue_triage_state_validate.down.sql")
	...
	applyMigrationFile(t, ctx, s.pool, "968_issue_triage_state.down.sql")
