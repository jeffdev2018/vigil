...
func agentMemoryAsListRow(m db.AgentMemory) db.ListAgentMemoriesRow {
	return db.ListAgentMemoriesRow{
		ID: m.ID, WorkspaceID: m.WorkspaceID, AgentID: m.AgentID, Content: m.Content,
		Source: m.Source, SourceTaskID: m.SourceTaskID, CreatedAt: m.CreatedAt, UpdatedAt: m.UpdatedAt,
		Status: m.Status, Revision: m.Revision, ReviewedBy: m.ReviewedBy, ReviewedAt: m.ReviewedAt,
		ExpiresAt: m.ExpiresAt, SourceReview: m.SourceReview,
	}
}

func memoryExecutionSnapshot(m db.ListAgentMemoriesRow) memoryeval.Memory {
