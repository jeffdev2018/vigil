...
func (h *Handler) ListIssues(w http.ResponseWriter, r *http.Request) {
	...
	query := fmt.Sprintf(`SELECT i.id, i.workspace_id, i.title, i.description, i.status, i.priority,
	   ...
	   i.revision, i.goal_id, i.cycle_id, i.issue_type, i.recurrence_id, i.duplicate_of_issue_id
FROM issue i
WHERE %s
ORDER BY %s
...
SELECT
	...
	number, project_id, metadata, stage, properties, revision, goal_id, cycle_id, issue_type,
	duplicate_of_issue_id, group_total
FROM ranked
