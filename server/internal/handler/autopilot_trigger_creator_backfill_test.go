...
// Migration 952 fills a legacy trigger's missing creator from its autopilot's
...
func TestMigration952BackfillsTriggerCreatorFromAutopilot(t *testing.T) {
	...
	migration, err := os.ReadFile("../../migrations/952_autopilot_trigger_creator_from_autopilot.up.sql")
	if err != nil {
		t.Fatal(err)
	}
