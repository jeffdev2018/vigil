...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"agent_memory_evaluation":            workspaceDelete,
	"agent_memory_version":               workspaceDelete,
	"agent_effect":                       workspaceDelete,
	"issue_watchdog":                     workspaceDelete,
	"watchdog_verdict":                   workspaceDelete,
	"work_profile_observation":           workspaceDelete,
	"agent_correction_signal":            workspaceDelete,
	"contest":                            workspaceDelete,
	"org_structure":                      workspaceDelete,
	"org_revision":                       workspaceDelete,
	"org_offer":                          workspaceDelete,
	"org_flow":                           workspaceDelete,
	"workspace_transfer_run":             workspaceDelete,
	"workspace_model_key":                workspaceDelete,
	"workspace_sso_connection":           workspaceDelete,
	"scim_token":                         workspaceDelete,
	"project_member_role":                workspaceDelete,
	...
	"worktree_revert_request":            workspaceDelete,
	"run_branch_action_request":          workspaceDelete,
	...
	"workspace_note_embedding":           workspaceDelete,
	...
	"issue_delivery_contract":            workspaceDelete,
	"issue_delivery_review":              workspaceDelete,
	...
	"issue_plan":                         workspaceDelete,
	"epic_artifact":                      workspaceDelete,
	...
	"audit_log_entry":                    workspaceDelete,
	"decision_record":                    workspaceDelete,
	"business_rule":                      workspaceDelete,
	...
	"approval_gate_event":                workspaceDelete,
	"issue_transition_rule":              workspaceDelete,
	"issue_transition_rule_actor":        workspaceDelete,
	...
	// The subscription belongs to a (user, workspace) pair: the user keeps
	// their calendar, this workspace's link to it goes.
	"user_calendar_feed":             workspaceDelete,
	...
	"project_memory_version":         workspaceDelete,
	...
	"triage_item":                    workspaceDelete,
	"triage_source":                  workspaceDelete,
	...
	"workspace_note":                 workspaceDelete,
