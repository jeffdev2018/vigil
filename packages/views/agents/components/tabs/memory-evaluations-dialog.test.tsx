...
const memory: AgentMemory = { id: "memory", agent_id: "agent", content: "Check assumptions", source: "manual", source_task_id: null, source_issue_id: null, created_at: "", updated_at: "", revision: 1, status: "pending" };
