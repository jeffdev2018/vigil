...
it("keeps failures visible, retries, and distinguishes unknown coverage and old versions",async()=>{
 ...
 const history=mount([{id:memoryId,agent_id:"agent",content:"Current rule",revision:3,source:"manual",state:"approved",status:"active",source_task_id:null,source_issue_id:null,created_at:"",updated_at:""}]);
