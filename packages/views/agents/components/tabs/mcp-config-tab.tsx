...
function McpWorkspaceServerRow({
  ...
  return (
    ...
    // container and the shared row treatment lives on the inner div.
    <li>
      <div className="group flex min-h-16 items-center gap-3 px-4 py-3 transition-colors hover:bg-muted/30">
