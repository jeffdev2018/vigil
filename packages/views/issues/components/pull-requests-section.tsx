...
export function PullRequestsSection({
  ...
  /** Blocks rendered above and below the linked-PR list when the section is
   *  open — merge readiness, the stack, walkthroughs, review flags. They share
   *  this section's header and collapse instead of opening their own. */
  above?: ReactNode;
  below?: ReactNode;
}) {
  const { t } = useT("issues");
