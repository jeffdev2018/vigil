...
// The section renders PullRequestList, which reads the workspace from the
// route provider. In the app it always mounts under a workspace route; here
// there is no route, so the id is supplied directly — same as cycle-picker.
